...
def main():
    ...
    parser.add_argument("--amp", choices=["auto", "float16", "bfloat16", "none"], default="auto", help="CUDA mixed precision used while extracting frozen features. auto prefers bfloat16 when supported.")
    parser.add_argument("--compile", dest="compile", action="store_true", default=False, help="Use torch.compile for faster long embedding jobs when supported.")
