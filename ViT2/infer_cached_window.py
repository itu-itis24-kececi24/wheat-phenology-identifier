...
def encode_one_image(
    ...
    transform = TileTransform(image_size=image_size)
...
def main():
    ...
    parser.add_argument("--image-backbone", default=None, help="Torchvision ViT architecture. Defaults to checkpoint/cache metadata.")
    parser.add_argument("--image-backbone-weights", default=None, help="Optional .pt/.pth image-backbone state dictionary.")
    parser.add_argument("--pretrained", action="store_true", help="Use pretrained ViT if no embedding cache is supplied.")
    ...
    ) or checkpoint.get("image_backbone") or "vit_b_16"
