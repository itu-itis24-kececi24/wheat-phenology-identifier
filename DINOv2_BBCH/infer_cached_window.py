...
from backbone_weights import load_backbone_weights, read_backbone_checkpoint
...
def main():
    ...
    parser.add_argument("--image-backbone", default=None, help="Hugging Face model ID or local model directory. Defaults to checkpoint/cache metadata.")
    ...
    backbone = args.image_backbone or weights_backbone or (
        embedding_cache.get("image_backbone") if embedding_cache is not None else None
    ) or checkpoint.get("image_backbone") or DINO_DEFAULT_BACKBONE
