...
def main():
    ...
    parser.add_argument("--out-dir", default="results_dinov2_bbch_gated_station_role_sweep")
    ...
    parser.add_argument("--tile-streams", choices=["none", "micro", "macro", "both"], default="both")
