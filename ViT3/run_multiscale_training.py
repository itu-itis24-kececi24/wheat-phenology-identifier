...
# Edit these values to change the fold split for ViT3 experiments.
...
def main():
    ...
    log(
        "ViT3 fold station counts from file constants: "
        f"train={n_train_groups} val={n_val_groups} test={n_test_groups}"
    )
    log(
        "ViT3 fold station diversity requirements: "
